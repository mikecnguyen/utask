                    ...
                    <div class="col-lg-8 col-md-8 col-sm-8 col-sx-12 no-padding">
                        <h2 class="block-title">
                            <span class="block-title-text" data-prefix="<?php _e('in', 'enginethemes'); ?>">
                                ...
                                if($search_result == 1) {
                                    printf(__('<span class="search-result-count">%s</span> Search result %s', 'enginethemes'), $search_result, $term_name);
                                } else {
                                    printf(__('<span class="search-result-count">%s</span> Search results %s', 'enginethemes'), $search_result, $term_name);
                                }
                                ?>
                            </span>
                        </h2>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-3 col-sm-12 col-sx-12">
                        ...
                        <div class="filter-tags">
                            ...
                            <?php
                            mje_show_filter_tags(array('skill'), array('hide_empty' => false), $term->slug);
                            ?>
                        </div>
                    </div>
