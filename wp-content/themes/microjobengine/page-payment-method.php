            ...
            <div class="col-lg-9 col-md-9 col-sm-12 col-sx-12 payment-method box-shadow">
                <div class="tabs-information">
                    <ul class="nav nav-tabs" role="tablist">
                        <li role="presentation" class="active"><a href="#bank-account" aria-controls="bank-account" role="tab" data-toggle="tab"><?php _e('Add a bank account', 'enginethemes'); ?></a></li>
                        <li role="presentation"><a href="#paypal-account" aria-controls="paypal-account" role="tab" data-toggle="tab"><?php _e('Paypal', 'enginethemes'); ?></a></li>
                    </ul>
