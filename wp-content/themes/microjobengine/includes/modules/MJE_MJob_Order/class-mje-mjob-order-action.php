    ...
    public function sync( $request ){
        ...
        if ( $response['success'] ) {
            ...
            if( isset( $request['custom_offer_id'] ) ) {
                $total = get_post_meta( $request['custom_offer_id'], 'custom_offer_budget', true );
            } else {
            ...
            if( $request['method'] == 'create' ) {
                ...
                update_post_meta( $result->ID, 'real_amount', mje_get_price_after_commission( $total ) );
